...
def get_args():
    ...
    parser.add_argument('--archs', type = str, default='AQA7', choices=['FineDiving', 'MTL-AQA', 'AQA7', 'JIGSAWS'], help = 'our approach')
    parser.add_argument('--benchmark', type = str, default='AQA7', choices=['FineDiving', 'MTL-AQA', 'AQA7', 'JIGSAWS'], help = 'dataset')
...
def setup(args):
    ...
    args.config = 'configs/{}_Unified.yaml'.format(args.benchmark)
